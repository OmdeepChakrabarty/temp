...
test('pipeline creates real composer with passes', () => {
  const p = capabilityFactory.createPipeline({ children:[] }, { matrix: new Float32Array(16) }, [], { renderer: { domElement: { width:1,height:1 }, getPixelRatio:()=>1, getSize:(v)=>{v.set(1,1);return v}, getContext:()=>({}) } }, undefined);
